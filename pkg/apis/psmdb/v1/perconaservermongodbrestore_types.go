...
func (r *PerconaServerMongoDBRestore) CheckFields() error {
	...
	if r.Spec.BackupSource != nil {
		...
		if len(r.Spec.StorageName) == 0 && r.Spec.BackupSource.Filesystem == nil && r.Spec.BackupSource.S3 == nil && r.Spec.BackupSource.Azure == nil {
			return errors.New("one of storageName, backupSource.filesystem, backupSource.s3 or backupSource.azure is required")
		}
	}
